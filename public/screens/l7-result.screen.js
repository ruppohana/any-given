...
export const PREVIEW = {
  landed: {
    ...
    returned: 25,
    bank: { balance: 212, start: 100, delta: 112, record: { landed: 11, missed: 10 }, streak: 1 },
    voided: 2,
  },
  missed: {
    play: {
    ...
    returned: 0,
    bank: { balance: 197, start: 100, delta: 97, record: { landed: 10, missed: 10 }, streak: 0 },
    voided: 2,
  },
  void: {
    play: {
    ...
    returned: 10,
    bank: { balance: 176, start: 100, delta: 76, record: { landed: 8, missed: 9 }, streak: 0 },
    voided: 1,
  },
  ...
  settling: {
    ...
    returned: null,
    bank: { balance: 187, start: 100, delta: 87, record: { landed: 10, missed: 10 }, streak: 0 },
    voided: 2,
  },
};
