...
test('Home has two doors, The Games and The Pools, and the third tab looks like where it goes', () => {
  ...
  // Then, 2026-09-12: "Rename the home page betting to Games." / "'The Games'.
  // And 'The Pools'".
  assert.ok(SRC.includes("{ id: 'allgames', h: 'The Games',"), 'The Games lands on All games');
  assert.equal(SRC.includes("h: 'Betting'"), false, 'the door is no longer called Betting');
  assert.ok(SRC.includes("{ id: 'pool', h: 'The Pools',"), 'The Pools');
